---
  ...
  <div class="download-card">
    ...
    <p class="download-text">
      Latest Android build for UTOPIA.
    </p>
    ...
    <a class="download-button" href="/static/downloads/Utopia-v2.2.2.apk" download>
      Download APK
    </a>
  ...
  .download-card {
    ...
    border-radius: 28px;
    background:
      radial-gradient(circle at top right, rgba(255, 184, 77, 0.14), transparent
  28%),
